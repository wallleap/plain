  ...
  <header class="flex flex-items-center flex-justify-between m-y-3 line-height-none">
    ...
    <nav class="m-0">
      <ul class="flex m-0 p-0 list-none text-gray-500">
        ...
        <li class="cursor-pointer flex-shrink-0 w-9 h-9">
          <router-link to="/about" class="flex flex-items-center flex-justify-center w-100% h-100% rd-100 hover:bg-gray-100">
            <i class="fa-solid fa-bullseye" />
          </router-link>
        </li>
        <li class="cursor-pointer flex-shrink-0 w-9 h-9">
          <router-link to="/friends" class="flex flex-items-center flex-justify-center w-100% h-100% rd-100 hover:bg-gray-100">
